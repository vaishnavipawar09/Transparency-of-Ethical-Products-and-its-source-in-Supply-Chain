...
<body>
	...
	{
	out.println("<script>alert('Medicine purchase complete!')</script>");	
	}
   %>
	<!-- <header>		
		<div class="container">
		  ...
		  <div class="col-sm-12 col-md-8">
			...
			<form action="u_savemedicine" method="post" class="form-block form-bold form-mb-20 form-h-35 form-brdr-b-grey pr-50 pr-sm-0">
					...
					<tr>
						...
						<td><input type="text" name="card_no"  placeholder="Enter Card Number" required="required" pattern="^[1-9]\d*(\.\d+)?$" /></td>
						
						<td><b>CVV Number</b></td>
						<td><input type="text" name="cvv" placeholder="Enter CVV Number" required="required" pattern="^[1-9]\d*(\.\d+)?$" /></td>
						
						
					</tr>
					<tr>
						<td><b>Expiry Date</b></td>
						<td><input type="date" name="Expirydate_card" required  /></td>
