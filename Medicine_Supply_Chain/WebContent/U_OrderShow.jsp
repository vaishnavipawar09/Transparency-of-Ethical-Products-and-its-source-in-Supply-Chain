		...
		<h2>Medicines Available</h2>
		 <div >
		  <div >
			...
			<td><h3>MFG_Date</h3></td>
			<td><h3>Price</h3></td>
			<td><h3>Expiry_Date</h3></td>
			<td><h3>Qty</h3></td>
			...
			<%
					  try{
						  int i=1;
						  String query="select * from distribute_medicine_info";
			...
			%>
				...
				<tr>
					...
					<td> <a href="U_DataShow.jsp?id=<%=rs.getString(1)%>" style=" color: white;" class="button">Order</a> 
