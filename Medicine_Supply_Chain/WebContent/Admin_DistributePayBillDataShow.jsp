...
<link rel="stylesheet" href="new/bootstrap.css">
 ...
 <style>
  ...
  margin: 0;
  padding: 0;
  background: url(https://images.pexels.com/photos/4040562/pexels-photo-4040562.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1);
...
<body background="https://images.pexels.com/photos/7680748/pexels-photo-7680748.jpeg?cs=srgb&dl=pexels-karolina-grabowska-7680748.jpg&fm=jpg&w=1400&h=8400">
<%
...
<div class="box">
		...
		<h2>Medicines Payment done by Distributers</h2>
<div >
 <div  >
<div >
...
<td><h3>Distribute_Email_ID</h3></td>
...
<%
 try{
 int i=1;
 String query="select * from distribute_medicine_info_bill";
