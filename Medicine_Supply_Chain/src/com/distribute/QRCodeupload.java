...
public class QRCodeupload extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String dncg=AESencrp.decrypt(data);
	          System.out.println(dncg);
			f.delete();
	    	...
	    	System.out.println(dncg+"\tMedicine No:"+medicinno);
	    	response.sendRedirect("Dist_ShowMedicine.jsp?medicinno="+medicinno);
	    	}
		} catch(Exception e) {
