...
<head>
  ...
  margin: 0;
  padding: 0;
  background: url(https://images.pexels.com/photos/7615571/pexels-photo-7615571.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940);
...
<body>
	...
	{
	out.println("<script>alert('Medicine Added!')</script>");	
	}
