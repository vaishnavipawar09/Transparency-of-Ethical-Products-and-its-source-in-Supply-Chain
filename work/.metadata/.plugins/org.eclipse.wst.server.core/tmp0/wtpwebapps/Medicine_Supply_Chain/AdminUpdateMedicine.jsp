	...
	<div class="mb-30 brdr-ash-1 opacty-5"></div>
		...
		<div class="row">
		  <div class="col-sm-12 col-md-8">
			...
			<form action="updatemedicine" method="post" class="form-block form-bold form-mb-20 form-h-35 form-brdr-b-grey pr-50 pr-sm-0">
			            	<table align="center" border="1"  cellpadding="5" cellspacing="5">
					 <tr>
						<td><h3>Medicine Name</h3></td>
						<td><input type="text" name="MedicineName"  required="required" value="<%=MedicineName %>" placeholder="Medicine Name"/></td>
					...
					<tr>
				     	<td colspan="2" align="center"><input type="submit" value="Save" style=" background: yellow;color:color: black;" class="button"/></td>
				    	<td colspan="2" align="center"><input type="reset" value="Reset" style="background: yellow;color: color: black;" class="button"/></td>
				    </tr>
				</table>
