...
<link rel="stylesheet" href="new/bootstrap.css">
 ...
 <style>
  ...
  margin: 0;
  padding: 0;
  background: url(https://images.pexels.com/photos/3850790/pexels-photo-3850790.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1);
...
<body background="https://images.pexels.com/photos/3850790/pexels-photo-3850790.jpeg?crop=entropy&cs=srgb&dl=pexels-ready-made-3850790.jpg&fit=crop&fm=jpg&h=1000&w=1300">
<%
...
<td><h3>DescriptionName</h3></td>
<td><h3>MFGDate</h3></td>
<td><h3>Price</h3></td>
<td><h3>Qty</h3></td>
<td><h3>ExpiryDate</h3></td>
<td><h3>Action</h3></td>
</tr>
<%
 try{
...
<td> <a href="AdminUpdateMedicine.jsp?id=<%=rs.getString(9)%>,<%=rs.getString(1)%>" style="color: white;"class="button1">Update</a>
</td>
</tr>  
<%}
i++;
